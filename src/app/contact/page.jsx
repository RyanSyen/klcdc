  ...
  return (
    <section className="py-20">
      <div className="container mx-auto ">
        ...
        <div className="pb-4">
          Kuala Lumpur Christian Disciples Church (KLCDC) is located in the
          heart of Kuchai Lama, Kuala Lumpur. We are easy to find and accesible
          from major roads and public transport. Whether you are visiting from
          nearby areas like Sri Petaling, Old Klang Road, we invite you to join
          us for our service. For directions, parking details or any other
          inquiries, feel free to reach out to us via the contact details below.
          We look forward to seeing you Christian Disciples Church Kuala Lumpur!
        </div>
          ...
          <Card className="w-[300px] h-[270px]">
            <CardHeader>
              ...
              <CardTitle className="pt-4 flex gap-4">
                Church Address
                <Link
                  href={"https://maps.app.goo.gl/3o8DJWt6tGq2xdEE9"}
                  target="_blank"
                >
                  <Image
                    src="/sports/google-maps.png"
                    height={24}
                    width={24}
                    alt="Google Maps"
                  />
            ...
            <CardContent>
              <p>
                30-2, Jalan Kuchai Maju 11, Kuchai Entrepreneurs Park, 58200
                Kuala Lumpur
              </p>
            </CardContent>
          </Card>
