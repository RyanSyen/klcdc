...
import { cn, sectionContainer, sectionGap } from "@/lib/utils";
  ...
  return (
    ...
    >
      <div className={cn(sectionContainer, "relative")}>
        ...
        >
          <div className={cn("flex flex-row justify-start", sectionGap)}>
...
export const Card = ({ card, index, layout = false }) => {
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto shadow">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
